...
?>
    ...
    <div id="header">
      ...
      <div id="header-bottom">
        ...
        <div id="header-bottom-left" class="col6">
          <?php if ($logo): ?>
        ...
        <div id="header-bottom-right" class="col6">
  ...
  <div id="content-inner">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix">
      ...
      <?php if ($page['sidebar_first']): ?>
        <div id="sidebar-first" class="col3 sidebar"><div class="section">
          <?php print render($page['sidebar_first']); ?>
        </div></div> <!-- /.section, /#sidebar-first -->
      <?php endif; ?>

      <div id="content" class="col6"><div class="section">
        <a id="main-content"></a>
      ...
      <?php if ($page['sidebar_second']): ?>
        <div id="sidebar-second" class="col3 sidebar"><div class="section">
    ...
    <?php if ($page['postscript']): ?>
      <div id="postscript" class="clearfix col12">
...
<div id="bottom">
  <div id="bottom-inner">
    <div id="bottom-left" class="col8">
      <?php print render($page['bottom_left']); ?>
    </div>
    <div id="bottom-right" class="col4">
...
<div id="footer">
  <div id="footer-inner" class="clearfix">
    ...
    <div id="footer-bottom">
      ...
      <div id="footer-bottom-left" class="col6">
        <?php print render($page['footer_bottom_left']); ?>
      </div>
      <div id="footer-bottom-right" class="col6">
